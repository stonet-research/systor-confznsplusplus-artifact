...
if __name__ == "__main__":
    ...
    queue_depths = np.arange(1, 8) # there are issues with active zones > 7
    ...
    ax.plot(write99_iops, write99, markersize = 4, marker = 'x', label="   1% finish")
    ax.plot(write95_iops, write95, markersize = 4, marker = 'o', label="   5% finish")
    ...
    plt.savefig(f"{file_path}/loaded_write_latency-finish_ns.pdf", bbox_inches="tight")
    plt.savefig(f"{file_path}/loaded_write_latency-finish_ns.png", bbox_inches="tight")
    plt.clf()
