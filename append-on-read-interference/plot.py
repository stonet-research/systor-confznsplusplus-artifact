...
if __name__ == "__main__":
    ...
    ax.plot(read100_iops, read100, markersize = 4, marker = '>', label="   0% append")
    ax.plot(read99_iops, read99, markersize = 4, marker = 'x',   label="   1% append")
    ax.plot(read95_iops, read95, markersize = 4, marker = 'o',   label="   5% append")
    ax.plot(read90_iops, read90, markersize = 4, marker = '<',   label=" 10% append")
    ax.plot(read75_iops, read75, markersize = 4, marker = '^',   label=" 25% append")
    ax.plot(read50_iops, read50, markersize = 4, marker = '*',   label=" 50% append")
    ...
    plt.savefig(f"{file_path}/loaded_read_latency-append.pdf", bbox_inches="tight")
    plt.savefig(f"{file_path}/loaded_read_latency-append.png", bbox_inches="tight")
    plt.clf()
