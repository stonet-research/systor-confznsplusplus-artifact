...
if __name__ == "__main__":
    ...
    for key, value in data.items():
        ...
        if numjobs == 14:
            ...
            x = int(math.log2(int(numjobs)))
        if 'wflow_100' in key:
            write100[x] = value["jobs"][0]["write"]["lat_ns"]["percentile"]["95.000000"]/1000/1000
            write100_iops[x] = value["jobs"][0]["write"]["iops_mean"]/1000
        elif 'wflow_99' in key:
            write99[x] = value["jobs"][1]["write"]["lat_ns"]["percentile"]["95.000000"]/1000/1000
            write99_iops[x] = value["jobs"][1]["write"]["iops_mean"]/1000
        elif 'wflow_95' in key:
            write95[x] = value["jobs"][1]["write"]["lat_ns"]["percentile"]["95.000000"]/1000/1000
            write95_iops[x] = value["jobs"][1]["write"]["iops_mean"]/1000
        elif 'wflow_90' in key:
            write90[x] = value["jobs"][1]["write"]["lat_ns"]["percentile"]["95.000000"]/1000/1000
            write90_iops[x] = value["jobs"][1]["write"]["iops_mean"]/1000
        elif 'wflow_75' in key:
            write75[x] = value["jobs"][1]["write"]["lat_ns"]["percentile"]["95.000000"]/1000/1000
            write75_iops[x] = value["jobs"][1]["write"]["iops_mean"]/1000
        elif 'wflow_50' in key:
            write50[x] = value["jobs"][1]["write"]["lat_ns"]["percentile"]["95.000000"]/1000/1000
            write50_iops[x] = value["jobs"][1]["write"]["iops_mean"]/1000

    fig, ax = plt.subplots()

    ax.plot(write100_iops, write100, markersize=6, marker='x', label="100% write")
    ax.plot(write99_iops, write99, markersize=6, marker='o', label="  99% write")
    ax.plot(write95_iops, write95, markersize=6, marker='*', label="  95% write")
    ax.plot(write90_iops, write90, markersize=6, marker='<', label="  90% write")
    ax.plot(write75_iops, write75, markersize=6, marker='+', label="  75% write")
    ax.plot(write50_iops, write50, markersize=6, marker='^', label="  50% write")
    ...
    ax.set_xlim(left=0)
    ax.set_ylabel("p95 write Latency (msec)")
