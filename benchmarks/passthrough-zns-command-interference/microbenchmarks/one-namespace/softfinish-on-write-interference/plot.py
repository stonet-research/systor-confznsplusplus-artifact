...
if __name__ == "__main__":
    ...
    soft16_sleep = [None] * len(queue_depths)
    soft16_sleep_iops = [None] * len(queue_depths)    
    ...
    for key, value in data.items():
        ...
        print(key)
        if 'soft_0' in key:
            soft0[x] = value["jobs"][0]["write"]["lat_ns"]["percentile"]["95.000000"]/1000
            soft0_iops[x] = value["jobs"][0]["write"]["iops_mean"]/1000
        elif 'soft_8' in key:
            soft8[x] = value["jobs"][0]["write"]["lat_ns"]["percentile"]["95.000000"]/1000
            soft8_iops[x] = value["jobs"][0]["write"]["iops_mean"]/1000
        elif 'soft_16' in key and not 'sleep' in key:
            soft16[x] = value["jobs"][0]["write"]["lat_ns"]["percentile"]["95.000000"]/1000
            soft16_iops[x] = value["jobs"][0]["write"]["iops_mean"]/1000     
        elif 'soft_16' in key and 'sleep' in key:
            print('sleep')
            soft16_sleep[x] = value["jobs"][0]["write"]["lat_ns"]["percentile"]["95.000000"]/1000
            soft16_sleep_iops[x] = value["jobs"][0]["write"]["iops_mean"]/1000 
        elif 'soft_32' in key:
            soft32[x] = value["jobs"][0]["write"]["lat_ns"]["percentile"]["95.000000"]/1000
            soft32_iops[x] = value["jobs"][0]["write"]["iops_mean"]/1000     
        elif 'soft_64' in key:
            soft64[x] = value["jobs"][0]["write"]["lat_ns"]["percentile"]["95.000000"]/1000
            soft64_iops[x] = value["jobs"][0]["write"]["iops_mean"]/1000
        elif 'soft_128' in key:
            soft128[x] = value["jobs"][0]["write"]["lat_ns"]["percentile"]["95.000000"]/1000
            soft128_iops[x] = value["jobs"][0]["write"]["iops_mean"]/1000
        elif 'soft_256' in key:
            soft256[x] = value["jobs"][0]["write"]["lat_ns"]["percentile"]["95.000000"]/1000
            soft256_iops[x] = value["jobs"][0]["write"]["iops_mean"]/1000
        elif 'soft_512' in key:
            soft512[x] = value["jobs"][0]["write"]["lat_ns"]["percentile"]["95.000000"]/1000
            soft512_iops[x] = value["jobs"][0]["write"]["iops_mean"]/1000
    ...
    print(soft16_sleep_iops, soft16_sleep)
    ...
    ax.plot(soft16_sleep_iops, soft16_sleep, markersize = 4, marker = 's', linewidth=2,label="Soft-8KiB+sleep", color=GREEN)
