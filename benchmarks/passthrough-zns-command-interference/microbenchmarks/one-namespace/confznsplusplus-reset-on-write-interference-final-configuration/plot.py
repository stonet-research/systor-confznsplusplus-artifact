    ...
    for file in glob.glob(f'{data_path}/*'):
        ...
        with open(file, 'r') as f:
            for index, line in enumerate(f, 1):
                ...
                if len(line.split()) and  line.split()[0] == "{":
                    rows = f.readlines()
...
if __name__ == "__main__":
    ...
    print(write99_iops, write99)
    print(write95_iops, write95)
    print(write90_iops, write90)
    print(write75_iops, write75)
    print(write50_iops, write50)
