...
if __name__ == "__main__":
    ...
    for key, value in data.items():
        if "bw" in key:
            ...
            # iops_err[x] = value["jobs"][1]["ZNS Reset"]["iops_dev"]
    ...
    # plt.errorbar(X_, Y_, yerr=iops_plot_err, markersize = 4, marker = 'o', markevery=72) # 505 points = 504/8 (x-axis points) = 72 + Remainder 1 so the last marker shows
