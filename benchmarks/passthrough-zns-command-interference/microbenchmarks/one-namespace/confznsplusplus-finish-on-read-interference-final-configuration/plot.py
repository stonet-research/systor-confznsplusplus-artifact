...
if __name__ == "__main__":
    ...
    ax.plot(read50_32_iops, read50_32, markersize = 4, marker = '*',   label=" 50% finish-64KiB")
    ax.plot(read50_16_iops, read50_16, markersize = 4, marker = '*',   label=" 50% finish-32KiB")
    ax.plot(read50_8_iops, read50_8, markersize = 4, marker = '*',   label=" 50% finish-16KiB")
